...
// instead of putting the whole function in construtor,
// break apart as below
...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.createHeaderWaypoint(this.siteHeader);
	...
	_createClass(StickyHeader, [{
		...
		value: function createHeaderWaypoint(header) {
			var that = this;
			new Waypoint({
